...
export const metadata: Metadata = { title: 'Support — Customer Portal' };
          ...
          <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {contact.name && (
              <div>
                ...
                <dd className="mt-0.5 text-sm text-gray-900">{contact.name}</dd>
              </div>
            )}
            {contact.email && (
              <div>
            ...
            {contact.hours && (
              <div>
                <dt className="text-xs font-medium uppercase text-gray-500">Hours</dt>
                <dd className="mt-0.5 text-sm text-gray-900">{contact.hours}</dd>
              </div>
            )}
          </dl>
        </div>
