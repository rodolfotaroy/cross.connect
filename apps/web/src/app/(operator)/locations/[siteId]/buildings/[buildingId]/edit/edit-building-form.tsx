...
export function EditBuildingForm({ siteId, buildingId, defaults }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const outcome = await updateBuilding(siteId, buildingId, {
      ...
      router.push(`/locations/${siteId}/buildings/${buildingId}`);
      router.refresh();
  }
