...
const CrossConnectsIcon: SvgIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
const ReportsIcon: SvgIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
const SupportIcon: SvgIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
const NAV_ICONS: Record<string, SvgIcon> = {
  ...
  Organization: OrganizationsIcon,
  ...
  'My Team': TeamIcon,
  'Cross Connects': CrossConnectsIcon,
  Reports: ReportsIcon,
  Support: SupportIcon,
};
